...
},{"@babel/runtime/helpers/esm/objectSpread2":"../node_modules/@babel/runtime/helpers/esm/objectSpread2.js"}],"main.js":[function(require,module,exports) {
"use strict";
...
var tasksReducer = function tasksReducer() {
  ...
  switch (action.type) {
    case "ADD_TASK":
      return [].concat(_toConsumableArray(tasks), [action.payload]);
...
var addTask = function addTask(title) {
  var new_id = store.getState().tasksReducer.length > 0 ? store.getState().tasksReducer[store.getState().tasksReducer.length - 1].id + 1 : 1;
  return {
    type: "ADD_TASK",
    payload: {
      id: new_id,
